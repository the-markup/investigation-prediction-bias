...
The Markup and Gizmodo have obtained and analyzed actual predictions for more than three dozen departments that used PredPol predictive policing software for at least six months between 2018 and 2020. This data sheet provides the findings from our _disparate impact analysis_ and _public housing analysis_  for `r params$client_name` To learn more about the project read, our [investigation](https://themarkup.org/prediction-bias/2021/12/01/crime-prediction-software-promised-to-be-free-of-biases-new-data-shows-it-perpetuates-them). For more details on how we did this analysis, read our [methodology](https://themarkup.org/show-your-work/2021/12/01/how-we-determined-crime-prediction-software-disproportionately-targeted-low-income-black-and-latino-neighborhoods).
...
See the limitations section of the [methodology](https://themarkup.org/show-your-work/2021/12/01/how-we-determined-crime-prediction-software-disproportionately-targeted-low-income-black-and-latino-neighborhoods) for more details.
...
In some of the larger jurisdictions, more than five percent of block groups got zero predictions. In those cases, we chose the most populated block groups with no predictions for the five percent. Learn more about how we did this in our [methodology](https://themarkup.org/show-your-work/2021/12/01/how-we-determined-crime-prediction-software-disproportionately-targeted-low-income-black-and-latino-neighborhoods).
